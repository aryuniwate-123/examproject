        ...
        <div class="card-panel">
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="sroll" id="sroll" class="form-control" min="1" placeholder="e.g. 23" required>
                </div>
                
                <div class="form-group">
                    <label for="spwd">Account Password</label>
                    <input type="password" name="spwd" id="spwd" class="form-control" placeholder="Create secure password" required>
                </div>
                
                <button type="submit" name="addstudent" class="btn btn-primary btn-block mt-4">
                    <i class="la la-plus"></i> Register Student
                </button>
            </form>
        </div>
    </div>
    ...
    <div class="col-lg-8 mb-4">
        <div class="card-panel">
            <div class="card-panel-header d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3">
                ...
                <div class="no-print">
                    <input type="text" class="form-control form-control-sm" placeholder="Search students..." data-search-table="students-table">
                </div>
            </div>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                    ...
                                    <td class='text-right'>
                                        <form method='post' action='' onsubmit='return confirm(\"Are you sure you want to delete this student?\");' style='display:inline;'>
