    ...
    <div class="col-md-4 mb-4">
        <div class="card-panel">
            ...
            <form method="post" action="">
                ...
                <button type="submit" name="addclass" class="btn btn-primary btn-block mt-4">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                    ...
                                    <td class='text-right'>
                                        <form method='post' action='' onsubmit='return confirm(\"Are you sure you want to delete this class? This will delete all mapping students and subjects!\");' style='display:inline;'>
